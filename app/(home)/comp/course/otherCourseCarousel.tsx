        ...
        <div className="grid xs:grid-cols-2 md:grid-cols-3 grid-cols-3 justify-center gap-3 px-4 md:px-3 lg:px-0 lg:mb-12 exl:mb-2 xs:w-5/6 lg:w-4/6">
          {displayCourses.map((course) => (
            <Link
              ...
              } xs:w-[110px] sm:w-[150px] md:w-[170px] lg:w-[200px] exl:w-[300px] p-1 md:p-4 lg:p-4 rounded-[10px] lg:rounded-[18px] uws:w-[450px] mx-auto mt-2 lg:mt-1 exl:mt-5 uws:mt-7`}
            >
