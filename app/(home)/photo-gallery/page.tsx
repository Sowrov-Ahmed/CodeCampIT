...
const images = [
  '/images/home/home_gallery/home_gallery_6.jpeg',
  '/images/home/home_gallery/home_gallery_12.jpeg',
  '/images/home/home_gallery/home_gallery_7.jpeg',
  '/images/home/home_gallery/home_gallery_8.jpeg',
  '/images/home/home_gallery/home_gallery_9.jpeg',
  '/images/home/home_gallery/home_gallery_11.jpeg',
  '/images/home/home_gallery/home_gallery_12.jpeg',
  '/images/home/home_gallery/home_gallery_6.jpeg',
  '/images/home/home_gallery/home_gallery_7.jpeg',
  '/images/home/home_gallery/home_gallery_8.jpeg',
  '/images/home/home_gallery/home_gallery_9.jpeg',
  '/images/home/home_gallery/home_gallery_11.jpeg',
  '/images/home/home_gallery/home_gallery_13.jpeg',
  '/images/home/home_gallery/home_gallery_12.jpeg',
];
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#ededed]  mx-auto w-11/12">
      ...
      <div className="w-full  overflow-hidden relative">
        <div className={`flex transition-transform duration-700 ease-in-out ${images.length<3? 'justify-center' : ''}`}>
        ...
        <button
          onClick={prevImage}
          className={`absolute top-1/2 left-0 transform -translate-y-1/2 bg-black text-white p-2 rounded-full  hover:opacity-100 ${images.length < 3 && 'hidden'}`}
        >
          <IoIosArrowRoundBack className='text-md md:text-2xl lg:text-2xl' />
        </button>
        <button
          onClick={nextImage}
          className={`absolute top-1/2 right-0 transform -translate-y-1/2 bg-black text-white p-2 rounded-full  hover:opacity-100 ${images.length <3 && 'hidden'}`}
        >
...
<div className="w-full grid justify-between grid-cols-3 mt-8 gap-2 md:gap-4 lg:gap-4">
  ...
  <div>
    {images?.slice(Math.ceil(images.length / 3), Math.ceil((images.length / 3) * 2)).map((image, idx) => (
      <div key={idx}>
        <Image
          src={image}
          alt="images"
  ...
  <div>
    {images?.slice(Math.ceil((images.length / 3) * 2), images.length).map((image, idx) => (
      <div key={idx}>
        <Image
          src={image}
          alt="images"
          ...
          height={250}
          className="w-full mx-auto rounded-lg mb-2 md:mb-4 lg:mb-4"
          onClick={() => openModal(Math.ceil((images.length / 3) * 2) + idx)} 
        />
      </div>
    ))}
  </div>
